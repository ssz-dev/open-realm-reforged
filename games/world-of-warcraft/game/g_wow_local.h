...
#define BZ_WOW_PLAYER_COLLISION_RADIUS 0.6f
#define BZ_WOW_PLAYER_COLLISION_HEIGHT 2.0f
#define BZ_WOW_CREATURE_COLLISION_HEIGHT_SCALE 2.5f
#define BZ_WOW_COLLISION_SKIN 0.01f
#define BZ_WOW_COLLISION_BUMPS 3
