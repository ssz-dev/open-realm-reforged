...
typedef enum {
    ...
    WOW_WORLD_PROFILE_DOODAD_BROADPHASE_CANDIDATES,
    WOW_WORLD_PROFILE_DOODAD_INSTANCE_TESTS,
    WOW_WORLD_PROFILE_DOODAD_TRIANGLE_TESTS,
    WOW_WORLD_PROFILE_DOODAD_HITS,
    ...
    WOW_WORLD_PROFILE_AI_HIGH_UPDATES,
    WOW_WORLD_PROFILE_AI_MEDIUM_UPDATES,
    WOW_WORLD_PROFILE_AI_LOW_UPDATES,
    WOW_WORLD_PROFILE_AI_DEFERRED_UPDATES,
    WOW_WORLD_PROFILE_AI_DORMANT_FRAMES,
...
typedef struct {
    ...
    DWORD valid_tiles;
    DWORD wmo_instances;
    DWORD doodad_instances;
} WOWWORLDCACHESTATS;
typedef WOWWORLDCACHESTATS *LPWOWWORLDCACHESTATS;
typedef WOWWORLDCACHESTATS const *LPCWOWWORLDCACHESTATS;
